...
Tecnologias **.NET Framework**, **.NET Standard** e **.NET Core** foram utilizadas para o desenvolvimento de componentes de tela/apresentação (View e ViewModel) e também para o desenvolvimento da aplicação final, em WPF (*.NET Framework 4.6.1*, *.NET Framework 4.6.2*, *.NET Core 8.0* e *.NET Core 9.0*).
