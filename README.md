...
Após instalar e realizar a geração de um projeto à partir do **CrudGenerator**, basta seguir os passos abaixo para compilar e executar o projeto gerado:
 - Método 1:
   ...
   - Passo 3: Após a instalação do .NET SDK, abra o **Windows PowerShell**, navegue até a pasta selecionada para a geração do projeto CRUD via **CrudGenerator** e execute **./BuildAndRun.bat**; isto fará com que seja realizado o restore das depenências, compilação e execução do projeto **CRUD**.
